...
export default defineType({
  ...
  fields: [
    ...
    /* =========================================================
       AFFILIATE SOURCE
       Optional. Defaults to "Amazon" so ALL existing products
       continue working without any manual updates.
    ========================================================= */

    defineField({
      name: 'affiliateSource',
      title: 'Affiliate Source / Retailer',
      type: 'string',
      initialValue: 'Amazon',
      description: 'Which retailer does the affiliate link above point to? Defaults to Amazon — existing products need no changes.',
      options: {
        list: [
